...
public final class Constants {
    ...
    public static class DriveConstants {
        ...
        // public final double controllerRumbleValue = 0.5;
        // ^ part of RobotContainer Rumble() function, currently unused (controller 1 is
        // joystick)
        ...
        public static final double kMaxVelocityMetersPerSecond = (6380.0 / 60.0 * kMk4L1DriveReduction
                * kMk4WheelDiameter * Math.PI) * 0.5;// 6380.0 / 60.0 *kMk4L1DriveReduction * kMk4WheelDiameter *
                                                     // Math.PI

        // TODO: Change to an empirically measured value (currently this is just a
        // random multiplication)
        public static final double kMaxAccelerationMetersPerSecondSquared = (kMaxVelocityMetersPerSecond * 0.5); // previously
                                                                                                                 // 0.25
