...
public class NewLinearDriveCommand extends Command {
    ...
    public NewLinearDriveCommand(DriveSubsystem drive, double deltaX, double deltaY) {
        this(drive,deltaX,deltaY,0);
    }

    public NewLinearDriveCommand(DriveSubsystem drive, double deltaX) {
        this(drive,deltaX,0);
    }
     ...
     */
    public NewLinearDriveCommand(DriveSubsystem drive, double deltaX, double deltaY, double deltaAzimuth) {
        mDrive = drive;
        mDeltaX = deltaX;
        mDeltaY = deltaY;
