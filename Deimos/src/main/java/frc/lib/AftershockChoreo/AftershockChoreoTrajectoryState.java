...
public class AftershockChoreoTrajectoryState implements Interpolatable<AftershockChoreoTrajectoryState> {
   ...
   */
  public AftershockChoreoTrajectoryState(
      double timestamp,
      double x,
      double y,
      double heading,
   ...
   */
  @Override
  public AftershockChoreoTrajectoryState interpolate(AftershockChoreoTrajectoryState endValue, double t) {
    ...
    return new AftershockChoreoTrajectoryState(
   ...
   */
  public AftershockChoreoTrajectoryState flipped() {
    return new AftershockChoreoTrajectoryState(
        this.timestamp,
