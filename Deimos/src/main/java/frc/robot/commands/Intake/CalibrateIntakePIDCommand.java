...
public class CalibrateIntakePIDCommand extends Command {
    ...
    public CalibrateIntakePIDCommand(IntakeSubsystem mIntakeSubsystem, IntakeState desiredState) {
    ...
    @Override
    public void execute() {
        mIntakeSubsystem.runCalibrateIntake();    
    }
