...
// 	private int mClimberArmMotorID = 31; // FIXME these should be in Constants
// 	private int mClimberRollerMotorID = 30;
...
// 	private final Encoder m_encoder = new Encoder(6, 7, false, Encoder.EncodingType.k4X); // TODO placeholder numbers
