...
public class AftershockChoreoTrajectory {
  private final List<AftershockChoreoTrajectoryState> samples;

  /** Create an empty ChoreoTrajectory. */
  public AftershockChoreoTrajectory() {
    samples = List.of();
  }
   ...
   */
  public AftershockChoreoTrajectory(List<AftershockChoreoTrajectoryState> samples) {
   ...
   */
  public AftershockChoreoTrajectoryState getInitialState() {
   ...
   */
  public AftershockChoreoTrajectoryState getFinalState() {
    return samples.get(samples.size() - 1);
  }

  private AftershockChoreoTrajectoryState sampleInternal(double timestamp) {
   ...
   */
  public AftershockChoreoTrajectoryState sample(double timestamp) {
   ...
   * @return The ChoreoTrajectoryState at the given time.
   */
  public AftershockChoreoTrajectoryState sample(double timestamp, boolean mirrorForRedAlliance) {
   ...
   */
  public List<AftershockChoreoTrajectoryState> getSamples() {
    return samples;
  }
  ...
  public Pose2d[] getPoses() {
    return samples.stream().map(AftershockChoreoTrajectoryState::getPose).toArray(Pose2d[]::new);
  }
   ...
   */
  public AftershockChoreoTrajectory flipped() {
    var flippedStates = new ArrayList<AftershockChoreoTrajectoryState>();
    for (var state : samples) {
      flippedStates.add(state.flipped());
    }
    return new AftershockChoreoTrajectory(flippedStates);
  }
}